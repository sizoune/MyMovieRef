...
class FavoriteMovieAdapter(
...
) : PagedListAdapter<DetailPopularMovie, FavoriteMovieAdapter.MovieHolder>(DIFF_CALLBACK) {

    class MovieHolder(private val containerView: View) : RecyclerView.ViewHolder(containerView) {
        fun bindItemtoView(
            data: DetailPopularMovie,
    ...
    companion object {
        private val DIFF_CALLBACK: DiffUtil.ItemCallback<DetailPopularMovie> =
            object : DiffUtil.ItemCallback<DetailPopularMovie>() {
                override fun areItemsTheSame(
                    oldFav: DetailPopularMovie,
                    newFav: DetailPopularMovie
                ): Boolean {
