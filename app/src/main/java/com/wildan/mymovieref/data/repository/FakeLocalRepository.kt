...
object FakeLocalRepository {
    ...
    private val movieListType = object : TypeToken<List<FavoriteMovies>>() {}.type
    private val seriesListType = object : TypeToken<List<FavoriteTVSeries>>() {}.type

    fun loadFavoriteMovies(): List<FavoriteMovies> {
        return gson.fromJson(dummyFavMovies(), movieListType)
    }

    fun loadFavoriteTV(): List<FavoriteTVSeries> {
